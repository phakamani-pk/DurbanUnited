...
const results = [
  ['20 SEP 2026', 'AMAZULU', '1 — 1', 'DURBAN UNITED', '1 POINT'],
  ['06 SEP 2026', 'DURBAN UNITED', '2 — 1', 'ORLANDO PIRATES', '3 POINTS'],
